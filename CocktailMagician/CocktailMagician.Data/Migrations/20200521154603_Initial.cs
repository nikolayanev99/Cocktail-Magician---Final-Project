    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "5481ac0b-0ca9-4c26-a39a-dff7f589c3ed", "bar crawler", "BAR CRAWLER" },
                    { 2, "778bcf3e-d267-4956-b87f-5fdc37753aa9", "cocktail magician", "COCKTAIL MAGICIAN" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { 1, 0, "bb8cc7c3-5f37-40f3-ad66-abcea7006f5b", "admin@admin.com", false, false, null, "ADMIN@ADMIN.COM", "ADMIN", "AQAAAAEAACcQAAAAECWefVJaX0QT0Xvc1gdgvREev1r5vRVLhzAP46TS0AYtzM/vxPtWRsDwnWTDHSHNiw==", null, false, null, false, "Admin" });
