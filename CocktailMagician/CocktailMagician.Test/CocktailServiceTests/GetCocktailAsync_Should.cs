...
namespace CocktailMagician.Test.CocktailServiceTests
{
    ...
    {
        [TestMethod]
        public async Task GetCorrectModel_When_ParamsAreValid()
        {
            //Arrange
            var options = TestUtilities.GetOptions(nameof(GetCorrectModel_When_ParamsAreValid));
            ...
            using (var assertContext = new CocktailMagicianContext(options))
            {
                ...
                var result = await sut.GetCokctailAsync(1);
        ...
        public async Task Throw_When_NoCocktailFound()
        {
            ...
            {
                var sut = new CocktailService(assertContext, mockCocktailDtoMapper.Object, mockDateTimeProvider.Object, mockCocktailIngretientService.Object, mockIngredientsService.Object);
                await Assert.ThrowsExceptionAsync<ArgumentNullException>(() =>sut.GetCokctailAsync(1));
            }
